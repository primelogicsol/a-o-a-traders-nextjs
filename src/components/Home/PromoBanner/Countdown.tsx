    ...
    <section className="max-w-[1500px] w-full mx-auto px-4 sm:px-8 xl:px-0 mb-7.5">
      <div className="relative overflow-hidden z-1 rounded-lg bg-[#D0E9F3] p-4 sm:p-7.5 lg:p-10 xl:p-15">
        <div className="max-w-[422px] w-full">
          ...
          <h2 className="font-bold text-app_text text-xl lg:text-heading-4 xl:text-heading-3 mb-3">
          ...
          >
            ...
            <div>
              <span
                className="min-w-[64px] h-14.5 font-semibold text-xl lg:text-3xl text-app_text rounded-lg flex items-center justify-center bg-white shadow-2 px-4 mb-2"
                x-text="days"
              >
                {" "}
                {days < 10 ? "0" + days : days}{" "}
              </span>
              <span className="block text-custom-sm text-app_text text-center">
                Days
              </span>
            </div>
          ...
          <a
            href="#"
            className="inline-flex font-medium text-custom-sm text-white bg-app_blue py-3 px-9.5 rounded-md ease-out duration-200 mt-7.5"
          >
            Check it Out!
          </a>
        </div>
