        ...
        <div className="ax-w-[1500px] flex justify-center flex-col xl:flex-row gap-7.5">
          <div className="xl:max-w-[500px] w-full bg-white rounded-xl shadow-1">
            <div className="py-5 px-4 sm:px-7.5 border-b border-gray-3">
              <p className="font-medium text-xl text-app_text">
                Contact Information
              </p>
            </div>
          ...
          <div className="xl:max-w-[1000px] w-full bg-white rounded-xl shadow-1 p-4 sm:p-7.5 xl:p-10">
            <form>
              <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                <div className="w-full">
                  ...
                  <input
                    ...
                    id="firstName"
                    placeholder="Jhon"
                    className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-app_text w-full py-2.5 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-app_blue/20"
                  />
                </div>
              ...
              <div className="mb-7.5">
                ...
                <textarea
                  ...
                  className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-app_text w-full p-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-app_blue/20"
                ></textarea>
              </div>
