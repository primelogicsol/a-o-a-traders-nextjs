  ...
  return (
    <>
      ...
      <section className="bg-[#f3f4f6] py-[50px] px-[20px]">
        <div className="max-w-[1500px] mx-auto overflow-hidden relative">
          <div className="flex gap-[30px]">
            {/* <!-- Sidebar Start --> */}
            <div
              className={`sidebar-content fixed z-[10000] left-0 top-0 xl:translate-x-0 xl:static max-w-[310px] xl:max-w-[270px] w-full ease-out duration-200 ${
                productSidebar
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="bg-white shadow-1 rounded-lg py-4 px-5">
                    <div className="flex items-center justify-between">
                      <p>Filters:</p>
                      <button className="text-app_app_blue">Clean All</button>
                    </div>
                  </div>
