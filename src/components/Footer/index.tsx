...
const Footer = () => {
  ...
  return (
    <footer className="xl-max-w-[1500px] mx-auto overflow-hidden bg-app_blue text-white px-[50px] py-[40px]">
      {/* <!-- footer menu start --> */}
      <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between">
        <div className="max-w-[330px] w-full">
          <h2 className="mb-7.5 text-head-2 font-medium">Help & Support</h2>
        ...
        <div className="w-full sm:w-auto">
          <h2 className="mb-7.5 text-head-2 font-medium">Account</h2>
        ...
        <div className="w-full sm:w-auto">
          <h2 className="mb-7.5 text-head-2 font-medium">Our Policies</h2>
        ...
        <div className="w-full sm:w-auto">
          <h2 className="mb-7.5 text-head-2 font-medium">Terms & Conditions</h2>
        ...
        <div className="w-full sm:w-auto">
          <h2 className="mb-7.5 text-head-2 font-medium">
            Sign Up To Newsletter
          </h2>

          <p className="max-w-[300px] text-head-4">
            Join 60.000+ subscribers and get a new discount coupon on every
            Saturday.
          </p>

          <form className="w-full relative rounded-[5px] bg-white my-[10px]">
            <input
              type="text"
              placeholder="Your email address"
              className="w-full placeholder:text-app_text text-app_text border-none outline-none py-[13px] px-[10px] rounded-[5px]"
            />
            <button className="absolute right-0 font-normal text-white text-head-4 bg-orange py-[14px] px-[20px] rounded-[5px]">
              Get It Now
            </button>
          </form>
      ...
      {/* <!-- footer bottom start --> */}
        <div className="flex flex-wrap items-center justify-center gap-[80px] mt-[40px]">
          <p className="font-normal">
            ...
            <span className="text-orange"> Cyberbiz.</span>
          </p>
