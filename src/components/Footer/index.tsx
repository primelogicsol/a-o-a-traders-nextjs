      ...
      <div className="max-w-[1500px] mx-auto">
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between">
          <div className="max-w-[330px] w-full">
            <h2 className="mb-7.5 text-custom-xl font-medium">Help & Support</h2>
          ...
          <div className="w-full sm:w-auto">
            <h2 className="mb-7.5 text-custom-xl font-medium">Account</h2>
          ...
          <div className="w-full sm:w-auto">
            ...
            <form className="w-full relative overflow-hidden rounded-[5px] bg-white my-[10px]">
              <input
                type="text"
