...
const Header = () => {
  ...
  return (
    ...
    >
                ...
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    ...
                    <input
                      ...
                      autoComplete="off"
                      className="custom-search w-full rounded-full bg-gray-1 !border-l-0 border border-gray-3 py-2.5 pl-4 pr-10 outline-none ease-in duration-200"
                    />
      ...
      <div className="border-t border-gray-3 bg-app_blue text-white">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
                  ...
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      >
                        <Link
                          href={menuItem.path}
                          className={`hover:text-orange text-custom-sm font-medium  flex ${
            ...
            <div className="hidden xl:block">
              <ul className="flex items-center gap-5.5">
                ...
                <li className="py-4">
                  <Link
                    href="/wishlist"
                    className="flex items-center gap-1.5 font-medium text-custom-sm hover:text-orange"
                  >
                    <svg
                      className="fill-current"
                      width="16"
